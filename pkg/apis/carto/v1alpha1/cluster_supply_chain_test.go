...
var _ = Describe("ClusterSupplyChain", func() {
	Describe("SupplyChainSpec", func() {
		var (
			supplyChainSpec     v1alpha12.SupplyChainSpec
	...
	Describe("SupplyChainComponent", func() {
		var (
			supplyChainComponent     v1alpha12.SupplyChainComponent
	...
	Describe("Webhook Validation", func() {
		Describe("#Create", func() {
			Context("Well formed supply chain", func() {
				var wellFormedSupplyChain *v1alpha12.ClusterSupplyChain
				BeforeEach(func() {
					wellFormedSupplyChain = &v1alpha12.ClusterSupplyChain{
			...
			Context("Supply chain with a component reference that does not exist", func() {
				var supplyChain *v1alpha12.ClusterSupplyChain
						...
						Spec: v1alpha12.SupplyChainSpec{
							Components: []v1alpha12.SupplyChainComponent{
								...
								},
								{
									...
									Sources: []v1alpha12.ComponentReference{
										{
											Name:      "some-source",
			...
			Context("Two components with the same name", func() {
				var supplyChainWithDuplicateComponentNames *v1alpha12.ClusterSupplyChain
				BeforeEach(func() {
					supplyChainWithDuplicateComponentNames = &v1alpha12.ClusterSupplyChain{
						ObjectMeta: metav1.ObjectMeta{
							Name:      "responsible-ops---default-params",
							Namespace: "default",
						},
			...
			Describe("Template inputs must reference a component with a matching type", func() {
				...
				DescribeTable("template input does not match template type",
					func(firstComponentKind string, inputReferenceType string, happy bool) {
						...
						reference := v1alpha12.ComponentReference{
							Name:      "input-name",
						...
						case "Source":
							supplyChain.Spec.Components[1].Sources = []v1alpha12.ComponentReference{reference}
						case "Image":
							supplyChain.Spec.Components[1].Images = []v1alpha12.ComponentReference{reference}
						case "Config":
							supplyChain.Spec.Components[1].Configs = []v1alpha12.ComponentReference{reference}
						}
		...
		Describe("#Update", func() {
			var oldSupplyChain *v1alpha12.ClusterSupplyChain
			Context("Well formed supply chain", func() {
				var wellFormedSupplyChain *v1alpha12.ClusterSupplyChain
				BeforeEach(func() {
					wellFormedSupplyChain = &v1alpha12.ClusterSupplyChain{
			...
			Context("Template inputs do not reference a component with a matching type", func() {
				var invalidSupplyChain *v1alpha12.ClusterSupplyChain
				BeforeEach(func() {
					invalidSupplyChain = &v1alpha12.ClusterSupplyChain{
						ObjectMeta: metav1.ObjectMeta{
							Name:      "responsible-ops---default-params",
							Namespace: "default",
						},
				...
				It("validates on update as well", func() {
					err := invalidSupplyChain.ValidateUpdate(&v1alpha12.ClusterSupplyChain{})
					Expect(err).To(HaveOccurred())
		...
		Describe("#Delete", func() {
			Context("Any supply chain", func() {
				var anyOldSupplyChain *v1alpha12.ClusterSupplyChain
				It("does not return an error", func() {
	...
	Describe("GetSelectorsFromObject", func() {
		...
		Context("when object is a supply chain", func() {
			var sc *v1alpha12.ClusterSupplyChain

			BeforeEach(func() {
				sc = &v1alpha12.ClusterSupplyChain{Spec: v1alpha12.SupplyChainSpec{}}
			})
			Context("given a supply chain with 0 selectors", func() {
				BeforeEach(func() {
					actualSelectors = v1alpha12.GetSelectorsFromObject(sc)
				})
		...
		Context("when object is not a supply chain", func() {
			BeforeEach(func() {
				actualSelectors = v1alpha12.GetSelectorsFromObject(&v1alpha12.Workload{})
			})
			It("returns an empty list", func() {
				expectedSelectors = []string{}
				Expect(actualSelectors).To(ConsistOf(expectedSelectors))
