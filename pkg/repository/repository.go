...
type Repository interface {
	...
	GetClusterTemplate(reference v1alpha12.ClusterTemplateReference) (templates.Template, error)
	GetDeliveryClusterTemplate(reference v1alpha12.DeliveryClusterTemplateReference) (templates.Template, error)
	GetRunTemplate(reference v1alpha12.TemplateReference) (templates.ClusterRunTemplate, error)
	GetSupplyChainsForWorkload(workload *v1alpha12.Workload) ([]v1alpha12.ClusterSupplyChain, error)
	GetDeliveriesForDeliverable(deliverable *v1alpha12.Deliverable) ([]v1alpha12.ClusterDelivery, error)
	GetWorkload(name string, namespace string) (*v1alpha12.Workload, error)
	GetDeliverable(name string, namespace string) (*v1alpha12.Deliverable, error)
	GetSupplyChain(name string) (*v1alpha12.ClusterSupplyChain, error)
	StatusUpdate(object client.Object) error
	GetScheme() *runtime.Scheme
	GetPipeline(name string, namespace string) (*v1alpha12.Pipeline, error)
	ListUnstructured(obj *unstructured.Unstructured) ([]*unstructured.Unstructured, error)
	GetDelivery(name string) (*v1alpha12.ClusterDelivery, error)
}
...
func (r *repository) GetDelivery(name string) (*v1alpha12.ClusterDelivery, error) {
...
func (r *repository) GetClusterTemplate(ref v1alpha12.ClusterTemplateReference) (templates.Template, error) {
	return r.getTemplate(ref.Name, ref.Kind)
}

func (r *repository) GetDeliveryClusterTemplate(ref v1alpha12.DeliveryClusterTemplateReference) (templates.Template, error) {
	return r.getTemplate(ref.Name, ref.Kind)
}

func (r *repository) getTemplate(name string, kind string) (templates.Template, error) {
	apiTemplate, err := v1alpha12.GetAPITemplate(kind)
	if err != nil {
...
func (r *repository) GetRunTemplate(ref v1alpha12.TemplateReference) (templates.ClusterRunTemplate, error) {
...
func (r *repository) GetSupplyChainsForWorkload(workload *v1alpha12.Workload) ([]v1alpha12.ClusterSupplyChain, error) {
	list := &v1alpha12.ClusterSupplyChainList{}
	if err := r.cl.List(context.TODO(), list); err != nil {
		return nil, fmt.Errorf("list supply chains: %w", err)
	}

	var clusterSupplyChains []v1alpha12.ClusterSupplyChain
...
func (r *repository) GetDeliveriesForDeliverable(deliverable *v1alpha12.Deliverable) ([]v1alpha12.ClusterDelivery, error) {
	list := &v1alpha12.ClusterDeliveryList{}
	if err := r.cl.List(context.TODO(), list); err != nil {
		return nil, fmt.Errorf("list deliveries: %w", err)
	}

	var clusterDeliveries []v1alpha12.ClusterDelivery
...
func (r *repository) GetWorkload(name string, namespace string) (*v1alpha12.Workload, error) {
...
func (r *repository) GetDeliverable(name string, namespace string) (*v1alpha12.Deliverable, error) {
...
func (r *repository) GetPipeline(name string, namespace string) (*v1alpha12.Pipeline, error) {
...
func (r *repository) GetSupplyChain(name string) (*v1alpha12.ClusterSupplyChain, error) {
